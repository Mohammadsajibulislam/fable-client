        ...
        >
            ...
            <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-4">
                    <label
                        className="flex flex-col items-center justify-center w-28 h-36 rounded-xl cursor-pointer transition-all"
                        style={{
                            backgroundColor: "#0A1A0F",
                            border: "2px dashed #1E3A26",
                        }}
                    >
                        <input
                            type="file"
            ...
            <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                    ...
                    style={{
                        backgroundColor:
                            isLoading || isUploading ? "#15803D" : "#22C55E",
                        color: "#0A1A0F",
                    }}
                >
